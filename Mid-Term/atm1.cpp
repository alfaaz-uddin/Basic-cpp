...
int main()
{
   ...
   cout<<"ATM Menu: Your current balance is  BDT "<<curBal<<endl;;
    ...
    case 1 :
        ...
        if(curBal>wCash){
            curBal=curBal-wCash;
            cout<<"Success! Your current balance is BDT "<<curBal<<endl;
           tran1=wCash;
        } if(curBal<wCash) {
    ...
    case 2 :
        ...
        cout<<"Money sent! Your current balance is BDT "<<curBal<<endl;
        tran2=amount; }
        break;
    case 3 :
        ...
        break;
    case 4 :
        cout<<"Thank you for using our ATM, good luck!"<<endl;
        break;
         default :
